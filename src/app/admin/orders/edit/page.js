      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-8 max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <label className="block text-gray-800 font-semibold mb-3">Job Title *</label>
              <input
                type="text"
                name="jobTitle"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <label className="block text-gray-800 font-semibold mb-3">Budget *</label>
              <input
                type="number"
                name="budget"
            ...
            <div>
              <label className="block text-gray-800 font-semibold mb-3">Deadline *</label>
              <input
                type="date"
                name="deadline"
