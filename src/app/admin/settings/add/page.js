  ...
  return (
    <div className="min-h-screen bg-white p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Create a new platform configuration setting</p>
      </div>
      ...
      <div className="bg-white rounded-lg border-2 border-gray-200 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-semibold text-gray-800 mb-3">Setting Key *</label>
              <input
                type="text"
                name="settingKey"
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-800 mb-3">Setting Value *</label>
              <input
                type="text"
                name="settingValue"
