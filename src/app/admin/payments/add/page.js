  ...
  return (
    <div className="min-h-screen bg-white p-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Add New Payment</h1>
        <p className="text-gray-600">Record a new payment transaction for freelancers</p>
      </div>
      ...
      <div className="bg-white rounded-lg border-2 border-gray-200 p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-800 mb-3">Payment Date *</label>
              <input
                type="date"
                name="paymentDate"
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-800 mb-3">Notes</label>
            <textarea
              name="notes"
